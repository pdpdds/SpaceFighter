//=============================================================================
// Camera2.cpp by Frank Luna (C) 2004 All Rights Reserved.
//=============================================================================
#include "stdafx.h"
#include "Camera2.h"
...
const D3DXMATRIX& Camera2::view() const
{
	return mView;
}

const D3DXMATRIX& Camera2::proj() const
{
	return mProj;
}

const D3DXMATRIX& Camera2::viewProj() const
{
	return mViewProj;
}

const D3DXVECTOR3& Camera2::right() const
{
	return mRightW;
}

const D3DXVECTOR3& Camera2::up() const
{
	return mUpW;
}

const D3DXVECTOR3& Camera2::look() const
{
	return mLookW;
}

D3DXVECTOR3& Camera2::pos()
{
	return mPosW;
}

void Camera2::lookAt(D3DXVECTOR3& pos, D3DXVECTOR3& target, D3DXVECTOR3& up)
{
...
void Camera2::setLens(float fov, float aspect, float nearZ, float farZ)
{
...
void Camera2::setSpeed(float s)
{
	mSpeed = s;
}

bool Camera2::isVisible(const AABB& box)const
{
...
void Camera2::update2(float dt, Terrain* terrain, float offsetHeight)
{
...
*/
	...
	float pitch  =PI/2.0f; //gDInput->mouseDY() / 150.0f;
	float yAngle =0; //gDInput->mouseDX() / 150.0f;
...
void Camera2::update(float dt, Terrain* terrain, float offsetHeight)
{
	// Find the net direction the camera is traveling in (since the
	// camera could be running and strafing).
	...
	// We rotate at a fixed speed.
	float pitch  =0; //gDInput->mouseDY() / 150.0f;
	float yAngle =0; //gDInput->mouseDX() / 150.0f;
...
void Camera2::buildWorldFrustumPlanes()
{
