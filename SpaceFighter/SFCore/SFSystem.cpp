...
BOOL SFSystem::InitEnvironment()
{
	...
	m_pResMgr->AddResource(ITEM_BOX);
	...
	m_pSoundManager->Create( &g_pSoundGetItem, L"./GetItem.wav" , 0, GUID_NULL );
...
{ 
	m_pGameStateMachine->OnUpdate((float)fTime, fElapsedTime);
}
